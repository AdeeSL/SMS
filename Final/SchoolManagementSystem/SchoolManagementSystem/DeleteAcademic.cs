...
{
    public partial class DeleteAcademic : Form
    {
        ...
        private void DeleteAcademic_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'schoolManagementSystemDataSet1.Academic' table. You can move, or remove it, as needed.
            this.academicTableAdapter.Fill(this.schoolManagementSystemDataSet1.Academic);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (message == DialogResult.Yes)
                    {
...
)
                        {
                            ...
                            string str = "DELETE  FROM Academic WHERE ac_id='" + txtID.Text + "'";
                ...
                {
                    string str = "SELECT * FROM Academic";
                    SqlCommand cmd = new SqlCommand(str, con);
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    DataTable dt = new DataTable();
                    da.Fill(dt);
