        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    byte[] image = File.ReadAllBytes(x);
                    ...
                    con.Open();
                    string str = "INSERT INTO Student(full_name,initial,dob,gender,address,mobile,email,parent_name,parent_mobile,dp) VALUES('" + txtFullName.Text + "','" + txtNameWithInitial.Text + "','" + dateTimePicker1.Text + "','" + gender + "','" + txtAddress.Text + "','" + txtMobile.Text + "','" + txtEmail.Text + "','" + txtParent.Text + "','" + txtParentMobile.Text + "',@image)";
